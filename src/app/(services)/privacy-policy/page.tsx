  ...
  return (
    <main className="flex flex-col items-center">
      ...
      <p className="max-w-[768px] mb-12">
        合同会社J.N.Enterprise（以下、「当社」といいます。
        ）は、「個人情報の保護に関する法律」及び関連する政省令、ガイドライン等（以下、「法令等」といいます。）を遵守し、以下のとおり
        、個人情報を適切に管理・利用いたします。
        <br />
      ...
      {privacyPolicyTitleDescs.map((e, index) => (
...
const privacyPolicyTitleDescs = [
  ...
  {
    title: "Cookie・広告識別子・IPアドレス情報",
    descriptions: [
      "Cookie・広告識別子（Identifier for Advertisers/IDFA及びGoogle AdvertisingIdentifier/AAIDを含みますがこれに限りません。）・IPアドレス情報（以下、これらを総称して「Cookie等」といいます。）については、それら単独で特定の個人を識別することはできませんが、これら情報と個人情報が一体となって利用される場合にはこれら情報も個人情報として取り扱います。当社の運営するメディア等においては、たとえ特定の個人を識別することができなくとも、Cookie等を利用する場合には、その目的と方法を開示してまいります。また、Cookieや広告識別子については、ブラウザやOSでの設定で拒否することが可能です。当該拒否設定によりサービスが受けられない場合には、その旨も公表します。",
    ],
  },
  {
    title: "個人情報利用目的の特定",
