...
export default function TermsPage() {
  return (
    <main className="flex flex-col items-center">
      <AppHeader />
      <h1 className="mt-[100px] mb-[127px] text-center font-bold text-5xl">
        利用規約
      </h1>
      <p className="max-w-[768px] mb-12">
        本規約は、合同会社J.N.Enterprise（以下「当社」といいます。）が提供する「エール」（以下「本サービス」といいます。）を利用される際に適用されます。ご利用にあたっては、本規約をお読みいただき、内容をご承諾の上でご利用ください。
      </p>
      {termsTitleDescs.map((e, index) => (
        <p key={index} className="mb-12 max-w-[768px] w-full">
          <h1 className="mb-4 font-bold text-xl">
            {index + 1}. {e.title}
          </h1>

          {e.descriptions.map((desc, descIndex) => (
...
const termsTitleDescs = [
  {
    title: "販売事業者の名称",
    descriptions: ["合同会社J.N.Enterprise"],
  },
  {
    title: "規約の適用",
    descriptions: [
      ...
      "利用者が本サービスを利用した場合、利用者が本規約に同意したものとみなします。",
  ...
  },
  {
    title: "商品等の返品・交換",
    descriptions: [
      "本サービスに関する、商品等の返品及び交換は、以下の場合を除き、受け付けておりません。",
      "商品等の欠陥や不良による場合：",
  ...
  },
  {
    title: "利用者による投稿",
    descriptions: [
      "本サービス内における利用者による書き込み、レビュー、コメント等の情報及び利用者が掲載、アップロード又は閲覧可能にした画像、イラストその他のコンテンツ（以下「利用者投稿情報」といいます。）は、本サービスの不特定多数の利用者からアクセス及び閲覧されることを十分に理解の上、本サービスをご利用ください。利用者の投稿情報については、これを行った利用者が一切の責任を負うものとします。",
      ...
      "コンピュータウィルスを含むもの",
      "当社の認めるウェブサイト以外のウェブサイトへのリンクやURL",
      "その他当社が不適当と判断するもの",
      "利用者は、当社が利用者の投稿情報を無償で使用することを許諾するものとします。許諾にあたり、利用者は以下を表明し保証するものとします。",
      ...
      "当社は、利用者の投稿情報が本規約に違反する場合又は以下の事由に該当する場合、利用者への事前の通知なく利用者の投稿情報を削除すること及び利用者の投稿の制限を行うことができるものとします。",
      "投稿から一定期間以上経過した場合",
      "本サービスの保守管理上、必要と認められる場合",
      "利用者投稿情報等の容量が当社の使用機器の所定容量を超過した場合又はその恐れが生じた場合",
      "当社は、前項による削除及び投稿の制限の理由につき、利用者に対し返答する義務を負うものではなく、削除及び制限につき、利用者に発生した損害又は不利益につき、責任を負いません。また、当社は、利用者の投稿情報の削除義務を負うものではありません。",
  ...
  },
  {
    title: "ポイントの付与",
    descriptions: [
      "当社は、利用者が本サービスの利用にあたり当社が定めた条件を満たす場合には、当社の定める数のポイントを利用者に付与することができるものとします。",
      "利用者は、携帯電話端末の機種変更等を行った場合には、利用者が保有していたポイントが引き継がれない可能性があることをあらかじめ承諾するものとします。",
      "利用者は、保有するポイントを当社が定める方法で利用することができるものとします。",
      "当社は、利用者が本規約に違反した場合その他当社が適当と判断した場合には、利用者のポイントの全部又は一部を取り消すことができるものとします。",
      "当社は、本条により取消又は消滅したポイントについて一切の責任を負わないものとします。",
    ],
  },
  {
    title: "利用者へのお知らせ",
